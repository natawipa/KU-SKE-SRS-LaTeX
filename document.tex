...
\def \srsTitle{Real-Time Figure Skating Jump Recognition using Computer Vision and Pose-Based LSTM (FigureFlow)}
\def \srsAuthorOne{Natawipa Poonyakariyakorn}
\def \srsAuthorTwo{Swischya Sunthonphusit}
\def\srsAuthorThree{--}
\def \srsAcademicYear{2027}

\def \srsAdvisorName{Asst. Prof.Dr. Paruj Ratanaworabhan}
\iffalse
